...
external interface App : EventEmitter {
    ...
    fun on(event: String /* 'gpu-info-update' | 'will-finish-launching' | 'window-all-closed' */, listener: Function<*>): App /* this */
...
external open class WebContents : NodeEventEmitter {
    ...
    open fun on(event: String /* 'destroyed' | 'devtools-closed' | 'devtools-focused' | 'devtools-opened' | 'devtools-reload-page' | 'did-finish-load' | 'did-start-loading' | 'did-stop-loading' | 'enter-html-full-screen' | 'leave-html-full-screen' | 'media-paused' | 'media-started-playing' | 'responsive' | 'unresponsive' */, listener: Function<*>): WebContents /* this */
    ...
    open fun on(event: String /* 'did-fail-load' | 'did-fail-provisional-load' */, listener: (event: Event, errorCode: Number, errorDescription: String, validatedURL: String, isMainFrame: Boolean, frameProcessId: Number, frameRoutingId: Number) -> Unit): WebContents /* this */
    ...
    open fun on(event: String /* 'update-target-url' | 'will-navigate' */, listener: (event: Event, url: String) -> Unit): WebContents /* this */
